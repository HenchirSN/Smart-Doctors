...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><?= $this->Html->link("Médicaments" , ['controller' => 'Medicaments', 'action' => 'add'])?></li>
                <li class="breadcrumb-item"><?= $this->Html->link("Ajout" , ['controller' => 'Medicaments', 'action' => 'add'])?></li>
