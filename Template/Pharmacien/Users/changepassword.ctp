                                    ...
                                    <p class="text-muted font-14 m-b-20">
                                     ...
                                     <?= $this->Form->create() ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->control('pass1',array('label'=>false, "class"=>"form-control", "placeholder"=>"Ancien mot de passe"  ));  ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="pass2">Nouveau mot de passe <span class="text-danger">*</span></label>
                                            <?php echo $this->Form->control('pass2',array('label'=>false, "class"=>"form-control", "placeholder"=>"Nouveau mot de passe"  ));  ?>
                                        </div>

                                        <div class="form-group">
                                            <label for="pass3">Confirmation mot de passe <span class="text-danger">*</span></label>
                                            <?php echo $this->Form->control('pass3',array('label'=>false, "class"=>"form-control", "placeholder"=>"Confirmation mot de passe"  ));  ?>
                                        </div>
