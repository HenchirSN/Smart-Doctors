...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><?= $this->Html->link("Rapports" , ['controller' => 'Docteurrapports', 'action' => 'add'])?></li>
                <li class="breadcrumb-item"><?= $this->Html->link("Ajout" , ['controller' => 'Docteurrapports', 'action' => 'add'])?></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    ...
                    <?= $this->Form->create($docteurrapport,array("class"=>"form-horizontal")) ?>
                    ...
                    <div class="form-group m-b-25">
                        <div class="col-12">
                            <label for="label">Remarques :</label>
                            <?php echo $this->Form->control('remarques',array('label'=>false, "class"=>"form-control", "placeholder"=>"vos remarques" ,"type"=>"textarea"));  ?>
