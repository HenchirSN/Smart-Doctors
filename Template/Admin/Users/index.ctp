        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(
                        '<button type="button" class="btn btn-outline-success waves-light waves-effect"> <i class="fa fa-thumbs-o-up"></i> </button>',
                        ['action' => 'reactive', $user->id],
                        ["escape"=>false, 'confirm' => __('Voulez vous réactiver ce compte ?', $user->label)]) ?>
