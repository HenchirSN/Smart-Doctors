...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><?= $this->Html->link("Rapports" , ['controller' => 'Admindocteurrapports', 'action' => 'add'])?></li>
                <li class="breadcrumb-item"><?= $this->Html->link("Ajout" , ['controller' => 'Admindocteurrapports', 'action' => 'add'])?></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    ...
                    <?= $this->Form->create($admindocteurrapport,array("class"=>"form-horizontal")) ?>
