...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><?= $this->Html->link("Rapports" , ['controller' => 'Admindocteurrapports', 'action' => 'index'])?></li>
                <li class="breadcrumb-item"><?= $this->Html->link("Rapports" , ['controller' => 'Admindocteurrapports', 'action' => 'index'])?></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <h4 class="m-t-0 header-title">Liste des rapports sur les docteurs : </h4>
                    <br/>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <?php foreach ($rapports as $rapport): ?>
                            <tr>
                                ...
                                <td><?= h($rapport['profile']['specialité']) ?></td>

                                <td><?= h($rapport->objet) ?></td>
                                <td><?= h($rapport->created) ?></td>
