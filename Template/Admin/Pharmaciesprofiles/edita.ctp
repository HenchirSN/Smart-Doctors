...
<div class="custom-modal-text">
    <?= $this->Form->create($pharmaciesprofile,array("class"=>"form-horizontal")) ?>
    <div class="form-group m-b-25">
        ...
        <div class="col-12">
            <label for="adress">profession :</label>
            <?php echo $this->Form->control('profession',array('label'=>false, "class"=>"form-control required", "placeholder"=>"profession" ));  ?>
