...
<?= $this->Html->script('admin/plugins/jquery-ui/jquery-ui.min') ?>
<?= $this->Html->script('admin/plugins/fullcalendar/js/fullcalendar.min') ?>
<?= $this->Html->script('admin/pages/jquery.calendar') ?>
