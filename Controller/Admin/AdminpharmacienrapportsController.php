...
class AdminpharmacienrapportsController extends AppController
{
    ...
    public function index()
    {
        ...
        foreach ($rapports as $rapport){
            $user=$this->Users->find('all', array(
                'conditions'=>array('id'=> $rapport->pharmacien_id)
            ))->First();
            ...
            $profile=$this->Pharmaciesprofiles->find('all', array(
                'conditions'=>array('id'=>$user['profile_id'])
            ))->First();
            $rapport['profile']=$profile;
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Adminpharmacienrapports->delete($adminpharmacienrapport)) {
            $this->Flash->adminsuccess(__('Le rapport sur le pharmacien a été supprimé.'));
        } else {
